...
public class PlayerShip extends Ship {
    ...
    @Override
    public void shoot() {
        if ((this.getHeading()%360.0) == 2.0 || (this.getHeading()%360.0) == 0.0){
           getGameState().addProjectile(new Projectile(this, -2, new int[]{this.getX(), this.getY()}, getGameState()));
        }
        else if ((this.getHeading()%360.0) == 268.0 || this.getHeading()%360.0 == 270.0){
           getGameState().addProjectile(new Projectile(this, 272, new int[]{this.getX(), this.getY()}, getGameState()));
        }
        else {
