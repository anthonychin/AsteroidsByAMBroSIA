...
/**
 * The <code>PlayerShip</code> class defines all the properties and methods appropriate to the player ship that are not included in Ship.
 * @author Anthony
 */
public class PlayerShip extends Ship{
     ...
     * The default is set to 0.09f.
     */
    final public static float ACCELERATION = 0.09f;
    /**
     * Value of the deacceleration of the player ship.
